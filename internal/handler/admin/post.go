...
func PostList(c *gin.Context) {
	...
	posts, err := dao.GetPosts(dao.PostParams{
...
func PostSave(c *gin.Context) {
	...
	for _, tagId := range post.TagIds {
		go dao.IncrTagCount(strconv.Itoa(tagId))
	}
	c.Redirect(http.StatusFound, "/admin")
}
