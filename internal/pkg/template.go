...
func Render(data map[string]interface{}, c *gin.Context, tpl string) {
	var tplPaths []string
...
func AdminRender(data map[string]interface{}, c *gin.Context, template string) {
	data["cdn"] = conf.Conf.App.Cdn
